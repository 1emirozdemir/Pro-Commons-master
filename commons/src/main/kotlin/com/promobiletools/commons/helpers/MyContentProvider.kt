package com.promobiletools.commons.helpers
...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.promobiletools.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.promobiletools.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.promobiletools.commons.SHARED_THEME_UPDATED"
        val MY_CONTENT_URI = Uri.parse("content://$AUTHORITY/themes")

        const val COL_ID = "_id"    // used in Pro Thank You
