...
import com.promobiletools.commons.extensions.launchUpgradeToProIntent
...
class UpgradeToProDialog(val activity: Activity) {
    ...
    private fun moreInfo() {
        activity.launchViewIntent("https://medium.com/@tibbi/some-pro-mobile-tools-apps-are-becoming-paid-d053268f0fb2")
    }
}
