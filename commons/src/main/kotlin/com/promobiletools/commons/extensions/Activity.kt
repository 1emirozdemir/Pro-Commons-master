...
import com.promobiletools.commons.models.*
import com.promobiletools.commons.views.MyTextView
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.sharex.android" || applicationId == "com.sharex.android") {
