package com.promobiletools.commons.extensions
...
import com.promobiletools.commons.helpers.*
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.promobiletools.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.promobiletools.commons.models.AlarmSound
import com.promobiletools.commons.models.SharedTheme
import com.promobiletools.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.promobiletools.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.promobiletools.thankyou")

fun Context.isAProApp() = packageName.startsWith("com.promobiletools.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.promobiletools."))
